...
function game(){
  ...
  instializeInDraw();// que inicializa o jogo dentro do canvas. 
  moveEnvironment(mario);// faz o ambiente do jogo se mover, seguindo a posição do personagem principal, "mario". 
  drawSprites();//desenhar todos os elementos do jogo na tela.
  
  if(gameConfig.status==='start'){
/* ele exibe um retângulo preto semi-transparente na tela e um texto branco com tamanho de fonte de
 40px que diz "Pressione qualquer tecla direcional para iniciar o jogo" no centro da tela.  */
    fill(0,0,0,150);
